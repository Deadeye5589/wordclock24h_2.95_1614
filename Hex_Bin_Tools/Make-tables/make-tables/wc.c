...
main (int argc, char ** argv)
{
    ...
    {
        printf ("<a href=%s?w=wc24h-de><font color=red>wc24h-de</font></a><BR>\n", url);
    }
    else
    {
        printf ("<a href=%s?w=wc24h-de>wc24h-de</a><BR>\n", url);
    }

    if (! strcmp (wcname, "wc24h-de2"))
    {
        printf ("<a href=%s?w=wc24h-de2><font color=red>wc24h-de2</font></a><BR>\n", url);
    }
    else
    {
        printf ("<a href=%s?w=wc24h-de2>wc24h-de2</a><BR>\n", url);
    }

    if (! strcmp (wcname, "wc24h-pl"))
    {
        printf ("<a href=%s?w=wc24h-pl><font color=red>wc24h-pl</font></a><BR>\n", url);
    }
    else
    {
        printf ("<a href=%s?w=wc24h-pl>wc24h-pl</a><BR>\n", url);
    }

    if (! strcmp (wcname, "wc24h-pl2"))
    {
        printf ("<a href=%s?w=wc24h-pl2><font color=red>wc24h-pl2</font></a><BR>\n", url);
    }
    else
    {
        printf ("<a href=%s?w=wc24h-pl2>wc24h-pl2</a><BR>\n", url);
    }

    if (! strcmp (wcname, "wc12h-de"))
    {
        printf ("<a href=%s?w=wc12h-de><font color=red>wc12h-de</font></a><BR>\n", url);
    }
    else
    {
        printf ("<a href=%s?w=wc12h-de>wc12h-de</a><BR>\n", url);
    }
    ...
    if (! strcmp (wcname, "wc12h-ch1"))
    {
        printf ("<a href=%s?w=wc12h-ch1><font color=red>wc12h-ch1</font></a><BR>\n", url);
    }
    else
    {
        printf ("<a href=%s?w=wc12h-ch1>wc12h-ch1</a><BR>\n", url);
    }

    if (! strcmp (wcname, "wc12h-ch2"))
    {
        printf ("<a href=%s?w=wc12h-ch2><font color=red>wc12h-ch2</font></a><BR>\n", url);
    }
    else
    {
        printf ("<a href=%s?w=wc12h-ch2>wc12h-ch2</a><BR>\n", url);
    }

    if (! strcmp (wcname, "wc12h-en1"))
    {
        printf ("<a href=%s?w=wc12h-en1><font color=red>wc12h-en1</font></a><BR>\n", url);
    }
    else
    {
        printf ("<a href=%s?w=wc12h-en1>wc12h-en1</a><BR>\n", url);
    }

    if (! strcmp (wcname, "wc12h-en2"))
    {
        printf ("<a href=%s?w=wc12h-en2><font color=red>wc12h-en2</font></a><BR>\n", url);
    }
    else
    {
        printf ("<a href=%s?w=wc12h-en2>wc12h-en2</a><BR>\n", url);
    }

    if (! strcmp (wcname, "wc12h-es"))
    {
        printf ("<a href=%s?w=wc12h-es><font color=red>wc12h-es</font></a><BR>\n", url);
    }
    else
    {
        printf ("<a href=%s?w=wc12h-es>wc12h-es</a><BR>\n", url);
    }

    if (! strcmp (wcname, "wc12h-fr"))
    {
        printf ("<a href=%s?w=wc12h-fr><font color=red>wc12h-fr</font></a><BR>\n", url);
    }
    else
    {
        printf ("<a href=%s?w=wc12h-fr>wc12h-fr</a><BR>\n", url);
    }

    if (! strcmp (wcname, "wc12h-se"))
    {
        printf ("<a href=%s?w=wc12h-se><font color=red>wc12h-se</font></a><BR>\n", url);
    }
    else
    {
        printf ("<a href=%s?w=wc12h-se>wc12h-se</a><BR>\n", url);
    }
    ...
    puts ("<BR>");
    printf ("<a href=%s?w=%s&x=%d&h=%d&m=%d>Stunde -</a>&nbsp;&nbsp;&nbsp;", url, wcname, mode, hour > 0 ? hour - 1 : 23, minute);
    printf ("<a href=%s?w=%s&x=%d&h=%d&m=%d>Stunde +</a>&nbsp;&nbsp;&nbsp;", url, wcname, mode, hour < 23 ? hour + 1 : 0, minute);
    puts ("<BR>");
    printf ("<a href=%s?w=%s&x=%d&h=%d&m=%d>Minute -</a>&nbsp;&nbsp;&nbsp;", url, wcname, mode, hour, minute >= step ? minute - step : 60 - step);
    printf ("<a href=%s?w=%s&x=%d&h=%d&m=%d>Minute +</a>&nbsp;&nbsp;&nbsp;", url, wcname, mode, hour, minute <= 60 - step ? minute + step : 0);
